...
func (mc *MongoClient) SendDocument(ctx context.Context,
	dbName string,
	collName string,
	doc map[string]interface{}) (interface{}, error) {
...
func (mc *MongoClient) GetDocumentByLogin(ctx context.Context,
	dbName string,
	collName string,
	login string) (interface{}, error) {
...
func (mc *MongoClient) DeleteDocumentByLogin(ctx context.Context,
	dbName string,
	collName string,
...
func (mc *MongoClient) GetAllDocuments(ctx context.Context,
	dbName string,
	collName string) ([]interface{}, error) {
	filter := make(map[string]interface{})
	collection := mc.client.Database(dbName).Collection(collName)
